...
public class ImageView31 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_image_view31);
    ...
    private void setInitialData() {
        ...
        animals.add(new Animal("  Это необычные по  конфигурации скальные образования. Оказалось, что данное место расположено недалеко от поселения, которое местные жители называют Гычи. Порывшись в интернете, обнаружили, что данное название никому не известно, как и значение данного слова. На картах этого поселения также нет.  Деревенские рассказали, что Гычи - это частное (видимо, фермерское) хозяйство, в котором живет только одна семья.", R.drawable.dsc_0203,R.drawable.dsc_0206,R.drawable.dsc_0211));
    }
}